...
if (Sys.getenv("USERNAME") == "WRQ") {
  ...
  # - Common path for storing important R-objects as back-up
  genObjPath <- "C:/Users/R5532132/OneDrive - FRG/GCRM/Classifier-Diagnostics/Objects/"
  ...
  # - Custom path where R-scripts are saved
  path_cust <- "C:/Users/R5668395/OneDrive - FRG/ClassDiag Repository/Classifier-Diagnostics/Scripts/"
  
  # - Common path for storing important R-objects as back-up
  genObjPath <- "C:/Users/R5668395/OneDrive - FRG/ClassDiag Repository/Classifier-Diagnostics/Objects/"
  
  # - Common path for saving important analytics (e.g., sampling)
  genFigPath <- "C:/Users/R5668395/OneDrive - FRG/ClassDiag Repository/Classifier-Diagnostics/Figures/"
